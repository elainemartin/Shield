...
/** This method is called from within the constructor to
    ...
    private void initComponents() {
        ...
        m_jPanelCentral.add(jPanel6, java.awt.BorderLayout.CENTER);
        ...
        m_jContEntries.add(jPanel1, java.awt.BorderLayout.CENTER);
    ...
    private void m_jNumberKeysKeyPerformed(com.openbravo.beans.JNumberEvent evt) {//GEN-FIRST:event_m_jNumberKeysKeyPerformed
        if (evt.getKey() == '='){
            JOptionPane.showMessageDialog(null,"Valued Customer, please acknowledge that you have\nread"
                    + " the following federal warnings"
                    + " regarding the purchase of\nmarijuana and marijuana related products:\n"
                    + "\n"
                    + "1. Drugged driving and the exacerbation of other adverse"
                    + " public health\n    consequences associated"
                    + " with marijuana use are illegal.\n"
                    + "\n"
                    + "2. It is illegal to grow marijuana on public lands due to the\n    attendant public safety"
                    + " and environmental dangers posed\n    by marijuana production on public lands.\n"
                    + "\n"
                    + "3. Marijuana use or possession on federal property is illegal.", "Customer Warning",JOptionPane.INFORMATION_MESSAGE);
        }
