 ...
 * @author  adrianromero
 */
public final class CustomersView_Regulators extends javax.swing.JPanel implements EditorRecord {
     ...
     * @param app
     * @param dirty */
    public CustomersView_Regulators(AppView app, DirtyManager dirty) {
        try {
...
// JG 3 Oct 2013 - Customer Transaction List
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Product");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"DUI", "Felony", "9/19/2008", "CO"},
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null}
            },
            new String [] {
                "Offense", "Offense Type", "Arrest Date", "State"
            }
        ));
